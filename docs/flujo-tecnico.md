...
- **Navegación unificada.** Noticias y repositorios comparten la misma barra (`site/_includes/nav-temporal.njk`): anterior, archivo de la sección y siguiente. La cabecera (`base.njk`) tiene tres pestañas: Noticias, Repositorios y Archivo.
